...
export default function UpVotedArtistCard(props) {
  ...
  return (
    <div className='w-[30%] flex-shrink-0 bg-white flex flex-col rounded rounded-t-xl overflow-hidden shadow-sm mb-4 hover:shadow-xl transition-shadow duration-300 '>
        <div className='gap-4 h-[200px] p-4 pb-0'>

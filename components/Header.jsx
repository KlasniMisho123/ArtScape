  ...
  return (
    <header className="py-2 px-6 border w-full flex justify-between ">
      <div className='flex row'>
        ...
        <h3 className='text-[30px]'> <span className={'titleGradientPurple ' + lobster.className}>Art</span><span className={'text-indigo-500 titleGradientRed ' + poppins.className}>Scape</span> </h3>
      </div>
